...
namespace CVARC.V2
{
    ...
    //        new List<ITestAction<TSensorData, TCommand>>();        
    ...
    //    {
    //        currentTest.Add(new ITestAction<TSensorData, TCommand> { Command = command });
    //    }

    //    protected virtual void AddTestAction(Asserter<TSensorData> assert)
    //    {
    //        currentTest.Add(new ITestAction<TSensorData, TCommand> { Asserter = assert });
    //    }
    //}
}
